...
# Modified from https://github.com/facebookresearch/pytorchvideo/blob/9180d6d57cb9e15100ec9df3a049cf8d1121b302/pytorchvideo/data/labeled_video_dataset.py
...
try:  # this class is not available in the pypi version of pytorchvideo package
    from pytorchvideo.data.clip_sampling import UniformClipSamplerTruncateFromStart
except ImportError:
...
class LabeledVideoDataset(torch.utils.data.IterableDataset):
    ...
    def __len__(self):
        ...
        """
        if isinstance(
            self._clip_sampler, (RandomClipSampler, ConstantClipsPerVideoSampler, UniformClipSamplerTruncateFromStart)
        ):
            return len(self.video_sampler)
        elif isinstance(self._clip_sampler, UniformClipSampler):
            return None
        ...
        Returns:
            ...
            .. code-block:: text

                {
                    ...
                    'aug_index': <aug_index>,
                    'clip_start_index': <first_frame_index>,
                }
        """
